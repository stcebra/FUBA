...
from defence.Backdoor_indicator_defense.models.simple import SimpleNet
...
class ResNet(SimpleNet):
    def __init__(self, block=BasicBlock, num_blocks=[2,2,2,2], num_classes=10, dataset='cifar'):
