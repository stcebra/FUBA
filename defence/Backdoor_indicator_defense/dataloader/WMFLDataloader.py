...
from defence.Backdoor_indicator_defense.utils.utils import NoiseDataset, RandomImages
...
class WMFLDataloader(AbstractDataloader):
    ...
    def create_loader(self):
        ...
        self.edge_poison_train, self.edge_poison_test =self.train_dataset, self.test_dataset
