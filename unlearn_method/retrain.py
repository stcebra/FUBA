...
def retrain(config: Config):
    """
    Retrain the global model using federated averaging after excluding
    the unlearn target client. Also evaluates and aggregates backdoor models.
    """
